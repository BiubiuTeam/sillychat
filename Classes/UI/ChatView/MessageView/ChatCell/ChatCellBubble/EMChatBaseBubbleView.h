...
#define BUBBLE_LEFT_IMAGE_NAME @"private/silly_chat_bubble_receiver.png" // bubbleView 的背景图片
#define BUBBLE_RIGHT_IMAGE_NAME @"private/silly_chat_bubble_sender.png"
