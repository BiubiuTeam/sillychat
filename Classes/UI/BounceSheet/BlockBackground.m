...
{
    static BlockBackground* s_instance = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        s_instance = [[BlockBackground alloc] init];
    });
    return s_instance;
}
...
{
    if (_actionSheet && [_actionSheet respondsToSelector:@selector(nextResponderToDismiss)]) {
        [_actionSheet performSelectorOnMainThread:@selector(nextResponderToDismiss) withObject:nil waitUntilDone:YES];
    }
}
@end
